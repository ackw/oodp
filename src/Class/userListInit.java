...
public class userListInit {
   ...
   public static void main(String[] args) throws IOException {
        ...
        u = new Student("Sum Ting Wong", "user3", "489cd5dbc708c7e541de4d7cd91ce6d0f1613573b7fc5b40d3942ccb9555cf35", false, U1923423H, 'F', "SG", "SCSE", 21, 21);
        userList.add(u);
        u = new Student("Low Mai Kai", "user4", "489cd5dbc708c7e541de4d7cd91ce6d0f1613573b7fc5b40d3942ccb9555cf35", false, U2032423H, 'M', "MY", "SCSE", 21, 9);
        userList.add(u);
        u = new Student("Won Jae", "chew0393", "489cd5dbc708c7e541de4d7cd91ce6d0f1613573b7fc5b40d3942ccb9555cf35", false, U1824273H, 'M', "KR", "SOH", 21, 3);
        userList.add(u);
